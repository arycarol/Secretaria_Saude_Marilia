...
public class TransportRequest : BaseEntity<TransportRequest, TransportRequestDTO, OutputTransportRequest>
{
    ...
    public TransportRequest(long userId, DateOnly date, TimeOnly hour, string transportKind, string transportStatus, string originLocation, string destinationLocation)
    {
        UserId = userId;
        Date = date;
        Hour = hour;
