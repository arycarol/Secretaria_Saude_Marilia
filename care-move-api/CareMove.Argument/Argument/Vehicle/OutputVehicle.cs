...
public class OutputVehicle : BaseOutput<OutputVehicle>
{
    ...
    public OutputVehicle(string name, string licensePlate, string vehicleCategory, string vehicleModel, string color, string vehicleFuelType, string vehicleStatus, string renavam, string year, int capacity)
    {
        Name = name;
