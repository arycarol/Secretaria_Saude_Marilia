...
public class InputCreateVehicle : BaseInputCreate<InputCreateVehicle>
{
    ...
    [JsonConstructor]
    public InputCreateVehicle(string name, string licensePlate, string vehicleCategory, string vehicleModel, string color, string vehicleFuelType, string vehicleStatus, string renavam, string year, int capacity)
    {
        Name = name;
