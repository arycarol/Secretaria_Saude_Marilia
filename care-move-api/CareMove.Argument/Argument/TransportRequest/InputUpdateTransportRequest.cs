...
public class InputUpdateTransportRequest : BaseInputUpdate<InputUpdateTransportRequest>
{
    ...
    public InputUpdateTransportRequest(long id, long userId, DateOnly date, TimeOnly hour, string transportKind, string originLocation, string destinationLocation) : base(id)
    {
        UserId = userId;
        Date = date;
        Hour = hour;
